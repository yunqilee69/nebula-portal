...
export function registerShellComponents() {
  ...
  registerComponents({
    ...
    "shell/OrgPermissionPage": async () => ({ default: (await import("../../pages/org-permission/list")).OrgPermissionPage }),
    "shell/MenuPermissionPage": async () => ({ default: (await import("../../pages/menu-permission/list")).MenuPermissionPage }),
    "shell/ButtonPermissionPage": async () => ({ default: (await import("../../pages/button-permission/list")).ButtonPermissionPage }),
