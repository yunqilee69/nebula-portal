...
export declare function NeFormDrawer({ title, open, onClose, onSubmit, submitting, width, submitText, children, }: NeFormDrawerProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=ne-form-drawer.d.ts.map